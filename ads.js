// 1. Configuração do Banner Nativo
// Certifique-se de que existe um <div id="ad-native-container"></div> no seu HTML
window.atOptions = {
...
// 2. Função para injetar os scripts de anúncios (Pop-under e Invoke)
function carregarAds() {
    ...
    scripts.forEach(url => {
        // Verifica se o script já não foi injetado para evitar duplicidade
...
// 3. Executa o carregamento assim que o script for lido
carregarAds();
